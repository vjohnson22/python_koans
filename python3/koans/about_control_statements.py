...
class AboutControlStatements(Koan):
    ...
    def test_for_statement_with_tuples(self):
        ...
        text = ["Contestant: Lancelot  Answer: Blue", "Contestant: Galahad   Answer: I don't know yet", "Contestant: Robin  Answer: Blue! I mean Green!", "Contestant: Arthur  Answer: Is that an African Swallow or European Swallow?" ]
